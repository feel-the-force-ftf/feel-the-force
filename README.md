...
```
2. Convert the data to a pickle file (without processing key points first).
```
...
3. Label semantically meaningful points for each task following commands:
...
5. Convert human hand poses to robot actions in the data.
```
